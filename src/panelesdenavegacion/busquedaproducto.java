...
public class busquedaproducto extends javax.swing.JPanel {
    ...
    private void cargar_productos() {
        ...
        res = conexion.Consulta("select idproducto_prov,producto,precio_compra,cantidad, presentacion from producto_proveedor where producto like '%"+ busquedadeproduc.getText() +"%' and cantidad > 0");
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Numero", "Nombre", "Precio", "Cantidad", "Presentacion"
            }
        ) {
    ...
    private void iniciar() {
        ...
        res = conexion.Consulta("select idproducto_prov,producto,precio_compra,cantidad, presentacion from producto_proveedor where cantidad > 0");
