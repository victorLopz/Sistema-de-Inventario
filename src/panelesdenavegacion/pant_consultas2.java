...
public class pant_consultas2 extends javax.swing.JPanel {
    ...
    public pant_consultas2() throws SQLException {
        initComponents();
        cargarproductos();
    }
    ...
    private void initComponents() {
        ...
        jLabel1.setText("Ganancia por Productos");
        ...
        jButton3.setText("Productos mas vendidos");
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        res = conexiones.conexion.Consulta("select  idproducto_prov,producto,precio_compra,precioventa from producto_proveedor where producto like '%" + jTextField1.getText() + "%'");
